# Dictionary for nob — sma

This repository contains source files for a dictionary from Norwegian Bokmål to South Sámi. The content is licensed under the CC-BY-4.0 license.
